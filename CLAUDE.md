...
- **La Villa Coliving** — coliving et colocation premium à la frontière de Genève, côté France. **29 chambres meublées** (16-24 m², privées — bornes lues dans `rooms`, constantes `STATS.roomSizeMin/Max`) dans **3 maisons** : La Villa (Ville-la-Grand), Le Loft (Ambilly), Le Lodge (Annemasse).
