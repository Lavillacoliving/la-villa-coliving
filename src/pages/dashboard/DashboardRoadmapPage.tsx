...
const DOMAINS: Domain[] = [
  ...
  {id:'d1',name:'Acquisition (prospects)',icon:'\ud83c\udfaf',tasks:[
    ...
    {id:'1.5',name:'Relancer prospects silencieux',state:'red',priority:'P2',phase:'phase-2',status:'not_started',doc:''},
  ...
  {id:'d2',name:'Gestion locataires',icon:'\ud83c\udfe0',tasks:[
    ...
    {id:'2.10',name:'Portail locataire',state:'red',priority:'P2',phase:'phase-2',status:'not_started',doc:'Spec_Portail_Locataire.md'},
  ...
  {id:'d6',name:'Infrastructure technique',icon:'\u2699\ufe0f',tasks:[
    {id:'6.1',name:'Dashboard → One Stop Shop',state:'green',priority:'P1',phase:'phase-1b',status:'in_progress',doc:''},
    ...
    {id:'6.8',name:'Migration dashboard → React',state:'red',priority:'P2',phase:'phase-2',status:'not_started',doc:'Frontend unique'},
    {id:'6.9',name:'Export Excel + Sheet sync',state:'green',priority:'P2',phase:'phase-2',status:'completed',doc:'Controle de gestion'},
    {id:'6.10',name:'Health Check Système hebdo',state:'red',priority:'P2',phase:'phase-2',status:'not_started',doc:'Bulletin lundi matin'},
  ]},
