        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-[11px] text-[#A8A29E] text-center mt-3">
              {en
                ? `1,360 CHF = median of current rents (leases signed at different dates); today's entry prices are ${PRICE_SHARED_EN_NUM} CHF (shared shower room) to ${PRICE_EN_NUM} CHF (private bathroom) — detail in the methodology.`
                : `1 360 CHF = médiane des loyers en cours (baux signés à des dates différentes) ; les prix d'entrée actuels vont de ${PRICE_SHARED_FR_NUM} CHF (salle d'eau partagée) à ${PRICE_FR_NUM} CHF (salle de bain privative) — détail en méthodologie.`}
            </p>
            <SourceLine>
              {en
          ...
          <div className="text-sm text-[#57534E] space-y-4 leading-relaxed mt-5">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-1.5 space-y-1">
                ...
                <li>{en ? "Rent: 2026 median of current rents, billed in CHF, all-inclusive. Today's entry prices (${PRICE_SHARED_EN_NUM} CHF with a shared shower room, ${PRICE_EN_NUM} CHF with a private bathroom) sit above this median — the gap comes from older leases still running. Occupancy: average across all houses since October 2021 — 98-99% depending on the year and the house; a recently opened house can temporarily sit below that level during its ramp-up. Length of stay: average over all residents." : "Loyer : médiane 2026 des loyers en cours, facturés en CHF, tout compris. Les prix d'entrée actuels (${PRICE_SHARED_FR_NUM} CHF avec salle d'eau partagée, ${PRICE_FR_NUM} CHF avec salle de bain privative) sont au-dessus de cette médiane — l'écart vient des baux plus anciens toujours en cours. Occupation : moyenne toutes maisons confondues depuis octobre 2021 — 98-99 % selon les années et les maisons ; une maison récemment ouverte peut passer temporairement en dessous pendant sa montée en charge. Durée de séjour : moyenne sur l'ensemble des résidents."}</li>
