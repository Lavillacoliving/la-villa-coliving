...
export function AnnemasseColocationPage() {
  ...
  return (
    <main className="relative pt-16">
      ...
      {/* ===== (Lot 4 puis addendum Lot 5, 04/09/2026) Et côté Genève ? Honnêteté géographique : une seule maison
          est à Annemasse même (Le Lodge), les deux autres sont dans l'agglo ; ancre exacte vers /colocation-geneve. ===== */}
