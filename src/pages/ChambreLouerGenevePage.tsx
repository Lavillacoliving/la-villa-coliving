...
import { chambreGeneveFaq } from "@/data/faq/chambreGeneveFaq";
...
export function ChambreLouerGenevePage() {
  ...
  return (
    <main className="relative pt-16">
      ...
      <FaqSection title={en ? "Renting a room near Geneva — frequently asked questions" : "Louer une chambre près de Genève — questions fréquentes"} items={chambreGeneveFaq[L]} emitSchema />
