      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg text-[#78716C]">
            {language === "en"
              ? "Rooms from CHF 1,380 to 1,490/month depending on the house. Everything included: rent, utilities, fiber, cleaning twice a week, gym, pool, streaming. No application or agency fees — deposit of 2 months' rent (excluding utilities)."
              : "Chambres de 1 380 à 1 490 CHF/mois selon la maison. Tout compris : loyer, charges, fibre, ménage 2x/semaine, salle de sport, piscine, streaming. Sans frais de dossier ni d'agence — caution de 2 mois de loyer (hors charges)."}
          </p>
