...
export const situationsFaq: SituationFaq[] = [
  ...
  },
  {
    ...
    fr: {
      ...
      more: { href: "/blog/quartiers-annemasse-ou-vivre-selon-profil", label: "Les quartiers d'Annemasse, sans langue de bois" },
    },
    en: {
      q: "Is Annemasse safe?",
      ...
      more: { href: "/blog/quartiers-annemasse-ou-vivre-selon-profil", label: "Annemasse's neighbourhoods, no spin" },
    },
  },
  {
