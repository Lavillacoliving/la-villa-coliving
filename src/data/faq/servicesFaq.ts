  ...
  en: [
    {
      ...
      a: `At La Villa Coliving, around twenty services are included in a single rent from ${PRICE_CHF_EN}/month: utilities, fibre internet up to 8 Gb/s, cleaning of common areas three times a week, pool, sauna, gym, yoga and fitness classes, streaming, community events and monthly delivery of essentials.`,
    },
    {
