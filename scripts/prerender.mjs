...
const BREADCRUMB_LABELS = {
  fr: {
    ...
    'chambre-a-louer-annemasse': 'Chambre à louer Annemasse',
    'chambre-a-louer-geneve': 'Chambre à louer près de Genève',
  ...
  en: {
    ...
    'annemasse-colocation': 'Coliving Annemasse',
    'chambre-a-louer-annemasse': 'Rooms for rent Annemasse',
    'chambre-a-louer-geneve': 'Rooms for rent near Geneva',
    'le-coliving': 'Coliving',
...
const STATIC_PAGE_CONFIG = {
  ...
  '/chambre-a-louer-geneve': { priority: '0.8', changefreq: 'weekly' },
