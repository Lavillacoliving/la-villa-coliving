...
Depuis 2019, le **[Léman Express](https://www.lemanexpress.ch)** relie de nombreuses communes françaises au cœur de Genève en **une vingtaine de minutes**, sans embouteillage ni stress de douane. Trains **toutes les 15 minutes** en heure de pointe (toutes les 30 min en heures creuses), du premier vers **5h30** au dernier vers **minuit**, dans des rames modernes climatisées avec **WiFi et prises électriques** — autant de temps utile pour lire, travailler ou souffler. Un **abonnement toutes zones** coûte de l'ordre de **80 CHF/mois** (abonnement zones 10+210, [tpg.ch](https://www.tpg.ch)), et beaucoup d'employeurs en remboursent une partie : un avantage souvent méconnu, à vérifier dans ta convention. Pour les titres combinés des deux côtés de la frontière, regarde du côté d'**[Unireso](https://www.unireso.com)** (le réseau genevois), des **[TPG](https://www.tpg.ch)** et des **[CFF](https://www.sbb.ch)**.
