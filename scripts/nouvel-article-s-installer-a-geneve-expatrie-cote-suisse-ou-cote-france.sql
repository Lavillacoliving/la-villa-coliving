-- ============================================================================
-- Nouvel article : s-installer-a-geneve-expatrie-cote-suisse-ou-cote-france (page de décision — brief « Conquête IA »)
-- Généré le 2026-09-07 par scripts/build-article-sql.mjs depuis content/decision-pages/s-installer-a-geneve-expatrie-cote-suisse-ou-cote-france.{fr,en}.md + .meta.json
-- Mode : insert (brouillon, is_published = false) · à appliquer par Jérôme (SQL Editor / MCP)
-- Relecture : https://www.lavillacoliving.com/blog/s-installer-a-geneve-expatrie-cote-suisse-ou-cote-france?preview=lavilla2026 (et /en/blog/…)
-- ============================================================================
...
INSERT INTO public.blog_posts (
  ...
  'S''installer à Genève : côté Suisse ou France ?',
  'Moving to Geneva: Swiss side or French side?',
  'Tu arrives à Genève avec un contrat et tu hésites entre la Suisse et la France voisine ? Ton permis décide, ton budget et ton délai font le reste : le guide pour trancher en une lecture.',
  'Arriving in Geneva with a contract and hesitating between Switzerland and neighbouring France? Your permit decides, your budget and timeline do the rest: the guide to settle it in one read.',
  'Suisse ou France voisine quand tu arrives à Genève ? Permis G ou B, dossier sans garant, délai réaliste, impôt et LAMal : le comparatif pour décider.',
  'Switzerland or the French side when you move to Geneva? G or B permit, no-guarantor file, realistic timeline, tax and health insurance: the comparison.',
  $fr$Tu as signé, ou tu vas signer, un contrat à Genève, et tu hésites entre habiter en Suisse et habiter en France voisine. Réponse courte : ton permis décide de ce que tu as le droit de faire, ton budget et ton délai décident du reste, et pour la plupart des salariés qui arrivent, la France voisine est possible dès le premier jour à condition de connaître trois règles. Ce guide est écrit pour les expatriés qui débarquent avec un contrat suisse, et surtout pour ceux qui doivent être installés dans les trente jours.
...
$en$,
  'Jerome Austin',
  'geneva',
  '/images/la villa/exterior/La Villa-100.webp',
  13,
  ARRAY['expatrié', 'genève', 'permis G', 'installation', 'frontalier'],
  'manual',
  false,
  NULL,
  now()
