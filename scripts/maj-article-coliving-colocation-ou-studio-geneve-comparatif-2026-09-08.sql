...
Le vrai coût d'un logement, c'est le loyer plus tout ce que l'annonce ne montre pas, et tout ce qu'elle ne te donne pas. Ordres de grandeur pour une personne seule qui travaille à Genève, septembre 2026, sans marque ; la colonne « grande résidence » reprend le site d'une résidence de coliving de plusieurs centaines de logements côté France.
...
|---|---|---|---|---|
| Loyer affiché | 1 200 à 2 500 CHF hors charges (annonces, 2026) | 600 à 1 000 € hors charges selon la commune (annonces, septembre 2026) | dès {{PRIX_DES}} tout inclus, {{PRIX_PRIVATIF}} avec salle d'eau privative | dès 750 € tout inclus, chambre avec salle de bain privée ; studios dès 920 € (site de la résidence, septembre 2026) |
...
Compte le loyer, 1 200 à 2 500 CHF hors charges (annonces, 2026), plus 300 à 450 CHF par mois de charges, d'électricité, d'internet, de redevance et d'abonnement tpg, plus 3 000 à 7 000 CHF de meubles si le studio est vide, et un dépôt bloqué jusqu'à trois mois de loyer (art. 257e CO).
...
The real cost of a home is the rent plus everything the listing does not show, and everything it does not give you. Orders of magnitude for a single person working in Geneva, September 2026, without brands; the "large residence" column repeats the website of a several-hundred-unit coliving residence on the French side.
...
|---|---|---|---|---|
| Advertised rent | 1,200 to 2,500 CHF excluding charges (listings, 2026) | 600 to 1,000 € excluding charges depending on the town (listings, September 2026) | from {{PRIX_DES}} all-inclusive, {{PRIX_PRIVATIF}} with a private shower room | from 750 € all-inclusive for a room with private bathroom, studios from 920 € (residence website, September 2026) |
